package com.lb.seckill.service.impl;


import com.lb.seckill.dao.SeckillDao;
import com.lb.seckill.dao.SuccessKilledDao;
...
import com.lb.seckill.service.SeckillService;
...
//                redisDao.putSeckill(seckill);
     ...
     */
    public SeckillExecution executeSeckill(String seckillId, long userPhone, String md5)
    ...
    @Override
    public SeckillExecution executeSeckillProcedure(String seckillId, long userPhone, String md5) {
        if (md5 == null || !md5.equals(getMD5(seckillId))) {
