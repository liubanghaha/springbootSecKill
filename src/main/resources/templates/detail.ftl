...
<!-- 开始编写交互逻辑 -->
<#--<script th:src="@{/static/js/seckill.js}"  type="text/javascript"></script>-->
<script type="text/javascript">
    $(function(){
        //使用EL表达式传入参数
        seckill.detail.init({
            seckillId : ${seckill.seckillId},
            startTime : ${startTime?c},//毫秒
            endTime : ${endTime?c}
        });
    });
    ...
    var seckill = {
        ...
        URL: {
            ...
            now: function () {
                return 'http://localhost:80/' + 'seckill/time/now';
            },
            exposer: function (seckillId) {
                return 'http://localhost:80/' + 'seckill/' + seckillId + '/exposer';
            },
            execution: function (seckillId, md5) {
                return 'http://localhost:80/' + 'seckill/' + seckillId + '/' + md5 + '/execution';
            }
        },
        // 处理秒杀逻辑
